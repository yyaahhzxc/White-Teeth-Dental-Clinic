                      ...
                      {visibleExpenses.length > 0 ? visibleExpenses.map((row, idx) => (
                        period !== 'Daily' ? (
                          ...
                          <Box key={
                            ...
                            <Box sx={{ flex: 2, textAlign: 'left', color: (theme) => theme.palette.mode === 'dark' ? theme.palette.text.secondary : '#6d6b80' }}>{new Date(row.date).toLocaleDateString()}</Box>
